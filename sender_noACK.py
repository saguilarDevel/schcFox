...
from Entities.Fragmenter import *
...
# 	print('sendData -> {}'.format(sendData.decode()))
# 	data_dict = {
# 		"deviceType": "01B29CC4",
# 		"device": "1B29CC4",
# 		"time": "1596713121",
# 		"data": "".format(sendData.decode()),
# 		"seqNumber": "39",
# 		"ack": "false"
# 	}
...
print("SCHC Fragmentation mode: Uplink No-ACK 4.5.1.1 ")
...
i = 0
current_window = 0
profile_uplink = Sigfox_Entity("UPLINK", "NO ACK")
...
# Fragment the file.
if profile_uplink.mode == "NO ACK":
	fragmenter = FragmenterNoAck(profile_uplink, payload)
...
while i < len(fragment_list):
	...
	if not retransmitting:
		...
		# Send the data.
		print("Sending...")
		# response = send_request(data, profile_uplink.RETRANSMISSION_TIMER_VALUE)
